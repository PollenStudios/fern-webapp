export const privacy_policy_data = {
  ...
  updated_paragraph:
    'This Privacy Policy governs the manner in which F3RN collects, uses, maintains, and discloses information collected from users (each, a "User") of the www.F3RN.xyz website ("Site"). This privacy policy applies to the Site and all products and services offered by F3RN.',
  ...
  collected_information_paragraph: 'F3RN may collect and use Users personal information for the following purposes: ',
  ...
  change_privacy_policy_paragraph:
    'F3RN has the discretion to update this privacy policy at any time. When we do, we will revise the updated date at the top of this page. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.',
