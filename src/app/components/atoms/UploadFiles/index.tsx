          ...
          >
            ...
            <div className='flex flex-col justify-center items-center'>
              ...
              <p className='text-center paragraph-2'>
                {isDragReject ? 'Not supported' : 'Upload Image'}
              </p>
            </div>
          </div>
        )}
    ...
    <div className='flex '>
      {imagePreview ? (
        <div
          className={
            profileImage
              ? tailwindCssClassForComponents.profileImage
              : tailwindCssClassForComponents.postImage
          }
        >
          {
            <img
              className={`w-full h-full ${
                profileImage ? 'object-cover rounded-full' : 'object-contain'
              } `}
              src={imagePreview}
        ...
        >
          ...
          <div>
            <p className='paragraph-2 flex  justify-center'>Upload image</p>
            <p className='text-center paragraph-3 text-gray-40 md:px-10'>
              Recommended size 430px x 450px{' '}
            </p>
          </div>
        </div>
      )}
