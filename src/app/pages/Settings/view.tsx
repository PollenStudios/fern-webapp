        ...
        <div className='flex justify-between'>
          ...
          <div className='mb-2 sm:mb-4 flex justify-end items-end'>
            {currentProfile?.artistApprovalStatus === null ? (
              <Button
                onClick={SignUpForArtist}
                variant='outline'
                name='Sign up for Artist'
                type='button'
              />
            ) : (
            ...
            <div className='flex justify-center flex-col'>
              <p className='heading-5 text-center py-5'>
                {currentProfile?.ownedBy
                  ? currentProfile?.ownedBy?.slice(0, 9) +
                    '...' +
                    currentProfile?.ownedBy?.slice(-4)
                  : ''}
              </p>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit(updateUserProfileData)} className='flex flex-col gap-4'>
              ...
              <div className='bg-gray-100 px-4 py-6 rounded-lg border mt-8'>
                ...
                <p className='heading-6 pt-2 text-gray-600'>
                  {`We suggest you to enable dispatcher so you don't need to sign all your
                  transactions in F3RN.`}
                </p>
              </div>
