...
import UserProfileSidebarSkelton from 'app/components/Skelton/UserProfileSidebarSkelton'
...
function UserProfileSidebar({userProfile, isArtist}: any) {
  ...
  const userProfileAttributes = {
    ...
    instagramValue: userProfile?.attributes.filter(
      (attribute: any) => attribute.key === 'instagram',
    ),
  }

  if (userProfile === undefined) {
    return <UserProfileSidebarSkelton />
  }
