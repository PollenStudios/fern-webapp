          ...
          <div className="p-6 pt-4">
            <div className=" flex justify-between">
              ...
              <div className="flex space-x-1 text-gray-300 ml-6">
                <div onClick={() => workInProgressAlert()} className="flex px-1.5  hover:bg-gray-800  rounded-sm cursor-pointer  items-center space-x-1.5">
                  <p className="font-light text-xl">{likes}</p>
                  <HeartIcon  className="w-6 text-white " />
                </div>
                <div onClick={() => workInProgressAlert()} className="flex px-2.5 hover:bg-gray-800 rounded-sm cursor-pointer  items-center space-x-1.5">
